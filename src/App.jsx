...
export default function App() {
  ...
  const handleSwap = async () => {
    ...
    alert(
      `Swapping ${fromAmount} ${fromToken.symbol} to ${toToken.symbol} (demo only)`
    );
  };
        ...
        <div className="rounded-3xl bg-[#18181b] border border-[#232336] shadow-2xl p-0">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-1">
              ...
              {authenticated && (
                <span className="text-xs text-gray-500">
                  Balance:{" "}
                  <span className="font-semibold">{fromBalance ?? "--"}</span>
                </span>
              )}
            </div>
            ...
            <div className="text-xs text-gray-500 mt-1">
              $
              {(fromAmount * 2500).toLocaleString(undefined, {
          ...
          <div className="p-6 pt-4">
            <div className="flex items-center justify-between mb-1">
              ...
              {authenticated && (
                <span className="text-xs text-gray-500">
                  Balance:{" "}
                  <span className="font-semibold">{toBalance ?? "--"}</span>
                </span>
              )}
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="text-xs text-gray-500 mt-1">
              $
              {(toAmount * 2500).toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}
            </div>
          </div>
